                            ...
                            {dataOrder.length > 0 ? (
                                dataOrder.map((item: ICarts) => (
                                    <div key={item.id} style={{ marginBottom: "20px", backgroundColor: "white", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "15px" }}>
                                        ...
                                        />
                                        <div >
                                            Tổng tiền: {formatCurrency(item.detail.price * item.quantityProducts)} VNĐ
                                        </div>
                                        <div>
                                            <DeleteOutlined
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <strong style={{
                                    ...
                                    Tổng tiền:    <strong style={{ color: "#1890ff" }}>{formatCurrency(totalAmount)} VNĐ</strong>
                                </strong>
                            </div>
                            ...
                            {dataOrder.length > 0 ?
                                ...
                                (
                                    <Button
                                        ...
                                        className="buttonOrder"
                                        onClick={() => message.warning("Vui lòng thêm sản phẩm vào giỏ hàng !!!")}
                                    >
